...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
	...
	<?
		$query = "select jumuns.opts_no2 as opts_no2, jumuns.num52 as num52, jumuns.cash52 as cash52, jumuns.discount52 as discount52,
			jumuns.price52 as price52, product.price52 as price52, 
			product.name52 as name52, opts1.name52 as name52, opts2.name52 as name52
			from jumuns, product, opts as opts1, opts as opts2
			where jumuns.product_no52 = product.no52
			and jumuns.opts_no52 = opts1.no52
			and jumuns.opts_no52 = opts2.no52
			and jumuns.jumun_no52 = '$no'";
		$result = mysqli_query($db, $query);
		if (!$result) exit("ERROR: $query");
		...
		for ($i=0; $i<$count; $i++) {
			...
			echo("<tr bgcolor='#EEEEEE' height='20'>	
					<td width='340' height='20' align='left'>$row1[name52]</td>	
					...
					<td width='60'  height='20' align='center'>$row1[name52]</td>");
			if ($row1['opts_no2'])
				echo("<td width='60'  height='20' align='center'>$row1[name52]</td>");
