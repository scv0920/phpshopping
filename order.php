...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td align = "center"><img src="images/order_title1.gif" width="65" height="15" border="0"></td>
				</tr>
				<tr><td height="10"></td></tr>
			</table>

			<table border="0" cellpadding="4" cellspacing="1" width="100%" class="cmfont" bgcolor="#CCCCCC">
				...
				<?
					...
					for ($i=0; $i<=$n_cart; $i++) {
						if ($cart[$i]) {
							...
							// 금액
							$ori_price = $row['price52'];
							$dis_price = round($row['price52'] * (100 - $row['discount52']) / 100, -3);
							$price = $row['icon_sale52'] == 1? $dis_price : $ori_price;
									...
									<td height='60' align='center' bgcolor='#FFFFFF'>
										<table cellpadding='0' cellspacing='0' width='100%'>
											<tr>
												...
												<td class='cmfont'>
													<a href='product_detail.php?no=$no'>$row[name52]</a><br>
													<font color='#0066CC'>[옵션사항]</font> $row1[name52]");
													if ($opts2) { echo(", $row2[name52]"); }
							echo("				</td>
											</tr>
										</table>
									</td>
