...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="5" cellspacing="1" width="100%" class="cmfont" bgcolor="#CCCCCC">
									...
									<td height='60' align='center'>
										<table cellpadding='0' cellspacing='0' width='100%'>
											<tr>
												...
												<td class='cmfont'>
													<a href='product_detail.php?no=$no'><font color='#0066CC'>$row[name52]</font></a><br>
													<font color='#0066CC'>[옵션]</font> $row1[name52], $row2[name52]
												</td>
											</tr>
										</table>
									</td>
